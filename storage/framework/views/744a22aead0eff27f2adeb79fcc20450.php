                ...
                <div class="card shadow-lg border-0">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-around flex-wrap">
                            <a href="<?php echo e(route('admin.supplier.index')); ?>" class="btn btn-info btn-lg mb-3 animate__animated animate__fadeInLeft" style="min-width: 200px;">
                                <i class="fas fa-truck mr-2"></i> Manage Suppliers
                            </a>
                            <a href="<?php echo e(route('admin.product.index')); ?>" class="btn btn-success btn-lg mb-3 animate__animated animate__fadeInUp" style="min-width: 200px;">
                                <i class="fas fa-box-open mr-2"></i> Manage Products
                            </a>
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-warning btn-lg mb-3 animate__animated animate__fadeInDown" style="min-width: 200px;">
                                <i class="fas fa-users mr-2"></i> Manage Users
                            </a>
                            <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-danger btn-lg mb-3 animate__animated animate__fadeInRight" style="min-width: 200px;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stylesphere\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>