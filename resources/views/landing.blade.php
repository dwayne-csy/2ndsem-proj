...
<body class="h-screen bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white">
    <div class="text-center p-10 bg-white bg-opacity-10 backdrop-blur-md rounded-lg shadow-lg">
        ...
        <div class="space-x-4">
            <a href="{{ url('/login') }}" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 transition-all rounded-lg shadow-md text-white text-lg">Login</a>
            <a href="{{ url('/register') }}" class="px-6 py-3 bg-green-500 hover:bg-green-600 transition-all rounded-lg shadow-md text-white text-lg">Register</a>
        </div>
    </div>
</body>
</html>
